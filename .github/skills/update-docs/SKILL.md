---
name: update-docs
description: STRICT PROTOCOL. Mandatory update or creation of README.md whenever code logic changes.
---
...
* **IF `README.md` IS MISSING:** You **MUST** create it immediately using this exact structure to answer the 4 questions:
    ```markdown
    # [Project Name]
...
2.  **Update Text:**
    ...
    * *Constraint:* Do not leave placeholder text like "TODO" regarding the new feature. Write the actual documentation.

## 4. Verification & Commit
You are not authorized to finish the turn until:
1.  `README.md` exists in the file list.
