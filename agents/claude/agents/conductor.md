---
description: Orchestrates the full Planning → Implementation → Review → Commit lifecycle for complex, multi-EPIC tasks. Invoke when a user requests a new feature, large refactor, or any work that needs a structured plan with TDD and subagent delegation.
---
